...
CREATE TABLE `ChartOfAccount` (
    ...
    `paymentMapping` ENUM('NONE', 'CASH_RECEIPT', 'SERVICE_REVENUE', 'DRUG_REVENUE', 'INVENTORY_ASSET', 'ACCOUNTS_PAYABLE', 'FIXED_ASSET', 'ACCUMULATED_DEPRECIATION', 'DEPRECIATION_EXPENSE', 'ASSET_DISPOSAL_LOSS', 'SALARY_EXPENSE', 'SALARY_PAYABLE') NOT NULL DEFAULT 'NONE',
